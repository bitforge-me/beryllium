...
from models import security, RestrictedModelView, ProposalModelView, UserModelView, TopicModelView, TokenTxModelView, \
    Role, User, Category, Proposal, TokenTx, Topic
