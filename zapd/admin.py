...
from models import security, RestrictedModelView, ProposalModelView, UserModelView, TransactionRestrictedModelView, \
...
admin.add_view(TransactionRestrictedModelView(Transaction, db.session))
